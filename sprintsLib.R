loadSprints <- function()
{
  ...
  sprints[sprints$id == 508 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-3-29 10:00')
  sprints[sprints$id == 508 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-4-11 10:00')
  sprints[sprints$id == 509 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-4-12 10:00')
  sprints[sprints$id == 509 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-4-25 10:00')
  sprints[sprints$id == 510 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-4-26 10:00')
  sprints[sprints$id == 510 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-5-9 10:00')
  sprints[sprints$id == 511 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-5-10 10:00')
  sprints[sprints$id == 511 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-5-23 10:00')
  sprints[sprints$id == 512 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-5-24 10:00')
  sprints[sprints$id == 512 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-6-6 10:00')
  sprints[sprints$id == 513 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-6-7 10:00')
  sprints[sprints$id == 513 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-6-20 10:00')
  sprints[sprints$id == 514 & is.na(sprints$sprintStartDate),]$sprintStartDate <- as.POSIXct('2017-6-21 10:00')
  sprints[sprints$id == 514 & is.na(sprints$sprintEndDate),]$sprintEndDate <- as.POSIXct('2017-7-4 10:00')
